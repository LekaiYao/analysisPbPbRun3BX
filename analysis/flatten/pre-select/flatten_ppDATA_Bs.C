...
void flatten_ppDATA_Bs::Loop(TString outputname)
//void flatten_ppDATA_Bs::Loop()
{
//   In a ROOT session, you can do:
//      root> .L flatten_ppDATA_Bs.C
//      root> flatten_ppDATA_Bs t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   */
   ...
   //TFile* outputFile = new TFile("./root_files/Bs/DATA_Bs.root", "RECREATE");
