...
// Thu Nov  6 07:30:48 2025 by ROOT version 6.30/04
// from TTree ntphi/
// found on file: /lstore/cms/hlegoinha/Bmeson/MC_DATA/DATA_ppref_Bmeson/DATA_ppref_Bmeson.root
//////////////////////////////////////////////////////////

#ifndef flatten_ppDATA_Bs_h
#define flatten_ppDATA_Bs_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           Bsize;
   Int_t           Bindex[25];   //[Bsize]
   Int_t           Btype[25];   //[Bsize]
   Float_t         Bmass[25];   //[Bsize]
   Float_t         Bpt[25];   //[Bsize]
   Float_t         By[25];   //[Bsize]
   Float_t         BvtxX[25];   //[Bsize]
   Float_t         BvtxY[25];   //[Bsize]
   Float_t         Bd0[25];   //[Bsize]
   Float_t         Bd0Err[25];   //[Bsize]
   Float_t         Bdxyz[25];   //[Bsize]
   Float_t         BdxyzErr[25];   //[Bsize]
   Float_t         Bchi2ndf[25];   //[Bsize]
   Float_t         Bchi2cl[25];   //[Bsize]
   Float_t         Bdtheta[25];   //[Bsize]
   Float_t         Bcos_dtheta[25];   //[Bsize]
   Float_t         Balpha[25];   //[Bsize]
   Float_t         BsvpvDistance[25];   //[Bsize]
   Float_t         BsvpvDisErr[25];   //[Bsize]
   Float_t         BsvpvDistance_2D[25];   //[Bsize]
   Float_t         BsvpvDisErr_2D[25];   //[Bsize]
   Float_t         Bnorm_svpvDistance[25];   //[Bsize]
   Float_t         Bnorm_svpvDistance_2D[25];   //[Bsize]
   Float_t         BQvalue[25];   //[Bsize]
   Float_t         BQvalueuj[25];   //[Bsize]
   Float_t         BQvaluemumu[25];   //[Bsize]
   Float_t         Btrk1Pt[25];   //[Bsize]
   Float_t         Btrk2Pt[25];   //[Bsize]
   Float_t         BtrkPtimb[25];   //[Bsize]
   Float_t         Btrk1Eta[25];   //[Bsize]
   Float_t         Btrk2Eta[25];   //[Bsize]
   Float_t         Btrk1PtErr[25];   //[Bsize]
   Float_t         Btrk2PtErr[25];   //[Bsize]
   Float_t         Btrk1Dz[25];   //[Bsize]
   Float_t         Btrk2Dz[25];   //[Bsize]
   Float_t         Btrk1DzError[25];   //[Bsize]
   Float_t         Btrk2DzError[25];   //[Bsize]
   Float_t         Btrk1Dxy[25];   //[Bsize]
   Float_t         Btrk2Dxy[25];   //[Bsize]
   Float_t         Bnorm_trk1Dxy[25];   //[Bsize]
   Float_t         Bnorm_trk2Dxy[25];   //[Bsize]
   Float_t         Btrk1DxyError[25];   //[Bsize]
   Float_t         Btrk2DxyError[25];   //[Bsize]
   Float_t         Btrk1nPixelLayer[25];   //[Bsize]
   Float_t         Btrk2nPixelLayer[25];   //[Bsize]
   Float_t         Btrk1nStripLayer[25];   //[Bsize]
   Float_t         Btrk2nStripLayer[25];   //[Bsize]
   Float_t         Btrk1Chi2ndf[25];   //[Bsize]
   Float_t         Btrk2Chi2ndf[25];   //[Bsize]
   Bool_t          Btrk1highPurity[25];   //[Bsize]
   Bool_t          Btrk2highPurity[25];   //[Bsize]
   Float_t         Btrk1dR[25];   //[Bsize]
   Float_t         Btrk2dR[25];   //[Bsize]
   Float_t         Btktkmass[25];   //[Bsize]
   Float_t         BtktkmassKK[25];   //[Bsize]
   Float_t         BtktkvProb[25];   //[Bsize]
   Float_t         Btktkpt[25];   //[Bsize]
   Float_t         Bdoubletmass[25];   //[Bsize]
   Float_t         Bmu1pt[25];   //[Bsize]
   Float_t         Bmu2pt[25];   //[Bsize]
   Bool_t          Bmu1highPurity[25];   //[Bsize]
   Bool_t          Bmu2highPurity[25];   //[Bsize]
   Bool_t          Bmu1isAcc[25];   //[Bsize]
   Bool_t          Bmu2isAcc[25];   //[Bsize]
   Bool_t          Bmu1SoftMuID[25];   //[Bsize]
   Bool_t          Bmu2SoftMuID[25];   //[Bsize]
   Bool_t          Bmu1HybridSoftMuID[25];   //[Bsize]
   Bool_t          Bmu2HybridSoftMuID[25];   //[Bsize]
   Bool_t          Bmu1isTriggered[25];   //[Bsize]
   Bool_t          Bmu2isTriggered[25];   //[Bsize]
   Float_t         Bmumumass[25];   //[Bsize]
   Float_t         Bujmass[25];   //[Bsize]
   Float_t         BujvProb[25];   //[Bsize]
   Float_t         Bgen[25];   //[Bsize]
   Int_t           BgenIndex[25];   //[Bsize]
   ...
   flatten_ppDATA_Bs(TTree *tree=0);
   virtual ~flatten_ppDATA_Bs();
...
#ifdef flatten_ppDATA_Bs_cxx
flatten_ppDATA_Bs::flatten_ppDATA_Bs(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/lstore/cms/hlegoinha/Bmeson/MC_DATA/DATA_ppref_Bmeson/DATA_ppref_Bmeson.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/lstore/cms/hlegoinha/Bmeson/MC_DATA/DATA_ppref_Bmeson/DATA_ppref_Bmeson.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/lstore/cms/hlegoinha/Bmeson/MC_DATA/DATA_ppref_Bmeson/DATA_ppref_Bmeson.root:/Bfinder");
      dir->GetObject("ntphi",tree);

   }
   Init(tree);
}

flatten_ppDATA_Bs::~flatten_ppDATA_Bs()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t flatten_ppDATA_Bs::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t flatten_ppDATA_Bs::LoadTree(Long64_t entry)
{
...
void flatten_ppDATA_Bs::Init(TTree *tree)
{
...
Bool_t flatten_ppDATA_Bs::Notify()
{
...
void flatten_ppDATA_Bs::Show(Long64_t entry)
{
...
Int_t flatten_ppDATA_Bs::Cut(Long64_t entry)
{
...
#endif // #ifdef flatten_ppDATA_Bs_cxx
