...
// Thu Nov  6 07:37:02 2025 by ROOT version 6.30/04
// from TTree ntphi/
// found on file: /lstore/cms/lekai/Bmeson/MC/ppRef/Bs_phat5_Bfinder.root
//////////////////////////////////////////////////////////

#ifndef flatten_ppMC_Bs_h
#define flatten_ppMC_Bs_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           Bsize;
   Int_t           Bindex[1352];   //[Bsize]
   Int_t           Btype[1352];   //[Bsize]
   Float_t         Bmass[1352];   //[Bsize]
   Float_t         Bpt[1352];   //[Bsize]
   Float_t         By[1352];   //[Bsize]
   Float_t         BvtxX[1352];   //[Bsize]
   Float_t         BvtxY[1352];   //[Bsize]
   Float_t         Bd0[1352];   //[Bsize]
   Float_t         Bd0Err[1352];   //[Bsize]
   Float_t         Bdxyz[1352];   //[Bsize]
   Float_t         BdxyzErr[1352];   //[Bsize]
   Float_t         Bchi2ndf[1352];   //[Bsize]
   Float_t         Bchi2cl[1352];   //[Bsize]
   Float_t         Bdtheta[1352];   //[Bsize]
   Float_t         Bcos_dtheta[1352];   //[Bsize]
   Float_t         Balpha[1352];   //[Bsize]
   Float_t         BsvpvDistance[1352];   //[Bsize]
   Float_t         BsvpvDisErr[1352];   //[Bsize]
   Float_t         BsvpvDistance_2D[1352];   //[Bsize]
   Float_t         BsvpvDisErr_2D[1352];   //[Bsize]
   Float_t         Bnorm_svpvDistance[1352];   //[Bsize]
   Float_t         Bnorm_svpvDistance_2D[1352];   //[Bsize]
   Float_t         BQvalue[1352];   //[Bsize]
   Float_t         BQvalueuj[1352];   //[Bsize]
   Float_t         Btrk1Pt[1352];   //[Bsize]
   Float_t         Btrk2Pt[1352];   //[Bsize]
   Float_t         BtrkPtimb[1352];   //[Bsize]
   Float_t         Btrk1Eta[1352];   //[Bsize]
   Float_t         Btrk2Eta[1352];   //[Bsize]
   Float_t         Btrk1PtErr[1352];   //[Bsize]
   Float_t         Btrk2PtErr[1352];   //[Bsize]
   Float_t         Bnorm_trk1Dxy[1352];   //[Bsize]
   Float_t         Bnorm_trk2Dxy[1352];   //[Bsize]
   Float_t         Bnorm_trk1Dz[1352];   //[Bsize]
   Float_t         Bnorm_trk2Dz[1352];   //[Bsize]
   Float_t         Btrk1nPixelLayer[1352];   //[Bsize]
   Float_t         Btrk2nPixelLayer[1352];   //[Bsize]
   Float_t         Btrk1nStripLayer[1352];   //[Bsize]
   Float_t         Btrk2nStripLayer[1352];   //[Bsize]
   Float_t         Btrk1Chi2ndf[1352];   //[Bsize]
   Float_t         Btrk2Chi2ndf[1352];   //[Bsize]
   Bool_t          Btrk1highPurity[1352];   //[Bsize]
   Bool_t          Btrk2highPurity[1352];   //[Bsize]
   Float_t         Btrk1dR[1352];   //[Bsize]
   Float_t         Btrk2dR[1352];   //[Bsize]
   Float_t         Btktkmass[1352];   //[Bsize]
   Float_t         BtktkvProb[1352];   //[Bsize]
   Float_t         Btktkpt[1352];   //[Bsize]
   Float_t         Bdoubletmass[1352];   //[Bsize]
   Float_t         Bmu1pt[1352];   //[Bsize]
   Float_t         Bmu2pt[1352];   //[Bsize]
   Float_t         Bmu1y[1352];   //[Bsize]
   Float_t         Bmu2y[1352];   //[Bsize]
   Bool_t          Bmu1highPurity[1352];   //[Bsize]
   Bool_t          Bmu2highPurity[1352];   //[Bsize]
   Bool_t          Bmu1isAcc[1352];   //[Bsize]
   Bool_t          Bmu2isAcc[1352];   //[Bsize]
   Bool_t          Bmu1SoftMuID[1352];   //[Bsize]
   Bool_t          Bmu2SoftMuID[1352];   //[Bsize]
   Bool_t          Bmu1HybridSoftMuID[1352];   //[Bsize]
   Bool_t          Bmu2HybridSoftMuID[1352];   //[Bsize]
   Bool_t          Bmu1isTriggered[1352];   //[Bsize]
   Bool_t          Bmu2isTriggered[1352];   //[Bsize]
   Float_t         Bmumumass[1352];   //[Bsize]
   Float_t         Bujmass[1352];   //[Bsize]
   Float_t         BujvProb[1352];   //[Bsize]
   Float_t         Bgen[1352];   //[Bsize]
   Int_t           BgenIndex[1352];   //[Bsize]
   ...
   flatten_ppMC_Bs(TTree *tree=0);
   virtual ~flatten_ppMC_Bs();
...
#ifdef flatten_ppMC_Bs_cxx
flatten_ppMC_Bs::flatten_ppMC_Bs(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/lstore/cms/lekai/Bmeson/MC/ppRef/Bs_phat5_Bfinder.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/lstore/cms/lekai/Bmeson/MC/ppRef/Bs_phat5_Bfinder.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/lstore/cms/lekai/Bmeson/MC/ppRef/Bs_phat5_Bfinder.root:/Bfinder");
...
flatten_ppMC_Bs::~flatten_ppMC_Bs()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t flatten_ppMC_Bs::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t flatten_ppMC_Bs::LoadTree(Long64_t entry)
{
...
void flatten_ppMC_Bs::Init(TTree *tree)
{
...
void flatten_ppMC_Bs::Show(Long64_t entry)
{
...
Int_t flatten_ppMC_Bs::Cut(Long64_t entry)
{
...
#endif // #ifdef flatten_ppMC_Bs_cxx
