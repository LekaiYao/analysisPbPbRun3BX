...
void flatten_ppDATA_Bu::Loop(TString outputname)
//void flatten_ppDATA_Bu::Loop()
{
//   In a ROOT session, you can do:
//      root> .L flatten_ppDATA_Bu.C
//      root> flatten_ppDATA_Bu t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   */
   ...
   //TFile* outputFile = new TFile("./root_files/Bu/DATA_Bu.root", "RECREATE");
