...
void flatten_ppDATA_X::Loop(TString outputname)
//void flatten_ppDATA_X::Loop()
{
//   In a ROOT session, you can do:
//      root> .L flatten_ppDATA_X.C
//      root> flatten_ppDATA_X t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   */
   ...
   //TFile* outputFile = new TFile("./root_files/X/DATA_X.root", "RECREATE");
