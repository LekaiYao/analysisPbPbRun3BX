...
void flatten_ppMC_Bs::Loop(TString outputname)
//void flatten_ppMC_Bs::Loop()
{
//   In a ROOT session, you can do:
//      root> .L flatten_ppMC_Bs.C
//      root> flatten_ppMC_Bs t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   /*
   int progressStep = 5;
   int nextPrint = progressStep;
   */

   TFile* outputFile = new TFile(outputname, "RECREATE");
   //TFile* outputFile = new TFile("./root_files/Bs/MC_Bs.root", "RECREATE");
   ...
   struct Out {
      ...
      Float_t Bnorm_trk1Dz;
      Float_t Bnorm_trk2Dz;
   ...
   // Branch definitions
   {
      ...
      tree->Branch("Bnorm_trk1Dz", &out.Bnorm_trk1Dz, "Bnorm_trk1Dz/F");
      tree->Branch("Bnorm_trk2Dz", &out.Bnorm_trk2Dz, "Bnorm_trk2Dz/F");
      ...
      tree->Branch("Bmu1y", &out.Bmu1y, "Bmu1y/F");
      tree->Branch("Bmu2y", &out.Bmu2y, "Bmu2y/F");
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      */
      ...
      for(i_B=0;i_B<Bsize;i_B++){
         ...
         if (!isMCsignal(i_B, Bgen)) continue;
         if (!isFID(i_B, Bpt, By)) continue;
         if (!isACC_pp(i_B, Btrk1Eta, Btrk2Eta, Btrk1Pt, Btrk2Pt, Bmu1isAcc, Bmu2isAcc)) continue;
         if (!isSEL_pp(i_B,
                        Btrk1PtErr, Btrk2PtErr, Btrk1Pt, Btrk2Pt,
                        Btrk1nPixelLayer, Btrk1nStripLayer,
                        Btrk2nPixelLayer, Btrk2nStripLayer,
                        Btrk1Chi2ndf, Btrk2Chi2ndf,
                        Btrk1highPurity, Btrk2highPurity,
                        Bmu1SoftMuID, Bmu2SoftMuID,
                        Bujmass, BujvProb)) continue;
         if (!isTRG(i_B, Bmu1isTriggered, Bmu2isTriggered)) continue;
         if (!isSpecCaseBs(i_B, Btktkmass)) continue;
         ...
         // Assignment code
         {
            ...
            out.Bnorm_trk1Dz = Bnorm_trk1Dz[i_B];
            out.Bnorm_trk2Dz = Bnorm_trk2Dz[i_B];
