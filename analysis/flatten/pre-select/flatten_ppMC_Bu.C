...
void flatten_ppMC_Bu::Loop(TString outputname)
//void flatten_ppMC_Bu::Loop()
{
//   In a ROOT session, you can do:
//      root> .L flatten_ppMC_Bu.C
//      root> flatten_ppMC_Bu t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   */
   ...
   //TFile* outputFile = new TFile("./root_files/Bu/MC_Bu.root", "RECREATE");
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      */
      ...
      for(i_B=0;i_B<Bsize;i_B++){
         ...
         if (!isACC_pp_Bu(i_B, Btrk1Eta, Btrk1Pt, Bmu1isAcc, Bmu2isAcc)) continue;
         if (!isSEL_pp_Bu(i_B,
                        Btrk1PtErr, Btrk1Pt,
