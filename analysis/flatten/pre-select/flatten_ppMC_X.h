...
// Wed Nov  5 02:03:39 2025 by ROOT version 6.30/04
// from TTree ntmix/
// found on file: /lstore/cms/hlegoinha/X3872/MC_DATA/prompt_X3872_to_Jpsi_Rho_phat5_Bfinder.root
//////////////////////////////////////////////////////////

#ifndef flatten_ppMC_X_h
#define flatten_ppMC_X_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   flatten_ppMC_X(TTree *tree=0);
   virtual ~flatten_ppMC_X();
...
#ifdef flatten_ppMC_X_cxx
flatten_ppMC_X::flatten_ppMC_X(TTree *tree) : fChain(0) 
{
...
flatten_ppMC_X::~flatten_ppMC_X()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t flatten_ppMC_X::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t flatten_ppMC_X::LoadTree(Long64_t entry)
{
...
void flatten_ppMC_X::Init(TTree *tree)
{
...
void flatten_ppMC_X::Show(Long64_t entry)
{
...
Int_t flatten_ppMC_X::Cut(Long64_t entry)
{
...
#endif // #ifdef flatten_ppMC_X_cxx
