...
// Thu Nov  6 06:57:29 2025 by ROOT version 6.30/04
// from TTree ntKp/
// found on file: /lstore/cms/hlegoinha/Bmeson/MC_DATA/DATA_ppref_Bmeson/DATA_ppref_Bmeson.root
//////////////////////////////////////////////////////////

#ifndef flatten_ppDATA_Bu_h
#define flatten_ppDATA_Bu_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           Bsize;
   Int_t           Bindex[91];   //[Bsize]
   Int_t           Btype[91];   //[Bsize]
   Float_t         Bmass[91];   //[Bsize]
   Float_t         Bpt[91];   //[Bsize]
   Float_t         By[91];   //[Bsize]
   Float_t         BvtxX[91];   //[Bsize]
   Float_t         BvtxY[91];   //[Bsize]
   Float_t         Bd0[91];   //[Bsize]
   Float_t         Bd0Err[91];   //[Bsize]
   Float_t         Bdxyz[91];   //[Bsize]
   Float_t         BdxyzErr[91];   //[Bsize]
   Float_t         Bchi2ndf[91];   //[Bsize]
   Float_t         Bchi2cl[91];   //[Bsize]
   Float_t         Bdtheta[91];   //[Bsize]
   Float_t         Bcos_dtheta[91];   //[Bsize]
   Float_t         Balpha[91];   //[Bsize]
   Float_t         BsvpvDistance[91];   //[Bsize]
   Float_t         BsvpvDisErr[91];   //[Bsize]
   Float_t         BsvpvDistance_2D[91];   //[Bsize]
   Float_t         BsvpvDisErr_2D[91];   //[Bsize]
   Float_t         Bnorm_svpvDistance[91];   //[Bsize]
   Float_t         Bnorm_svpvDistance_2D[91];   //[Bsize]
   Float_t         BQvalue[91];   //[Bsize]
   Float_t         BQvalueuj[91];   //[Bsize]
   Float_t         BQvaluemumu[91];   //[Bsize]
   Float_t         Btrk1Pt[91];   //[Bsize]
   Float_t         Btrk2Pt[91];   //[Bsize]
   Float_t         BtrkPtimb[91];   //[Bsize]
   Float_t         Btrk1Eta[91];   //[Bsize]
   Float_t         Btrk2Eta[91];   //[Bsize]
   Float_t         Btrk1PtErr[91];   //[Bsize]
   Float_t         Btrk2PtErr[91];   //[Bsize]
   Float_t         Btrk1Dz[91];   //[Bsize]
   Float_t         Btrk2Dz[91];   //[Bsize]
   Float_t         Btrk1DzError[91];   //[Bsize]
   Float_t         Btrk2DzError[91];   //[Bsize]
   Float_t         Btrk1Dxy[91];   //[Bsize]
   Float_t         Btrk2Dxy[91];   //[Bsize]
   Float_t         Bnorm_trk1Dxy[91];   //[Bsize]
   Float_t         Bnorm_trk2Dxy[91];   //[Bsize]
   Float_t         Btrk1DxyError[91];   //[Bsize]
   Float_t         Btrk2DxyError[91];   //[Bsize]
   Float_t         Btrk1nPixelLayer[91];   //[Bsize]
   Float_t         Btrk2nPixelLayer[91];   //[Bsize]
   Float_t         Btrk1nStripLayer[91];   //[Bsize]
   Float_t         Btrk2nStripLayer[91];   //[Bsize]
   Float_t         Btrk1Chi2ndf[91];   //[Bsize]
   Float_t         Btrk2Chi2ndf[91];   //[Bsize]
   Bool_t          Btrk1highPurity[91];   //[Bsize]
   Bool_t          Btrk2highPurity[91];   //[Bsize]
   Float_t         Btrk1dR[91];   //[Bsize]
   Float_t         Btrk2dR[91];   //[Bsize]
   Float_t         Btktkmass[91];   //[Bsize]
   Float_t         BtktkmassKK[91];   //[Bsize]
   Float_t         BtktkvProb[91];   //[Bsize]
   Float_t         Btktkpt[91];   //[Bsize]
   Float_t         Bdoubletmass[91];   //[Bsize]
   Float_t         Bmu1pt[91];   //[Bsize]
   Float_t         Bmu2pt[91];   //[Bsize]
   Bool_t          Bmu1highPurity[91];   //[Bsize]
   Bool_t          Bmu2highPurity[91];   //[Bsize]
   Bool_t          Bmu1isAcc[91];   //[Bsize]
   Bool_t          Bmu2isAcc[91];   //[Bsize]
   Bool_t          Bmu1SoftMuID[91];   //[Bsize]
   Bool_t          Bmu2SoftMuID[91];   //[Bsize]
   Bool_t          Bmu1HybridSoftMuID[91];   //[Bsize]
   Bool_t          Bmu2HybridSoftMuID[91];   //[Bsize]
   Bool_t          Bmu1isTriggered[91];   //[Bsize]
   Bool_t          Bmu2isTriggered[91];   //[Bsize]
   Float_t         Bmumumass[91];   //[Bsize]
   Float_t         Bujmass[91];   //[Bsize]
   Float_t         BujvProb[91];   //[Bsize]
   Float_t         Bgen[91];   //[Bsize]
   Int_t           BgenIndex[91];   //[Bsize]
   ...
   flatten_ppDATA_Bu(TTree *tree=0);
   virtual ~flatten_ppDATA_Bu();
...
#ifdef flatten_ppDATA_Bu_cxx
flatten_ppDATA_Bu::flatten_ppDATA_Bu(TTree *tree) : fChain(0) 
{
...
flatten_ppDATA_Bu::~flatten_ppDATA_Bu()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t flatten_ppDATA_Bu::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t flatten_ppDATA_Bu::LoadTree(Long64_t entry)
{
...
void flatten_ppDATA_Bu::Init(TTree *tree)
{
...
Bool_t flatten_ppDATA_Bu::Notify()
{
...
void flatten_ppDATA_Bu::Show(Long64_t entry)
{
...
Int_t flatten_ppDATA_Bu::Cut(Long64_t entry)
{
...
#endif // #ifdef flatten_ppDATA_Bu_cxx
