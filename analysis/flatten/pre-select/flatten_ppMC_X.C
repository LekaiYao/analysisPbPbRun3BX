...
void flatten_ppMC_X::Loop(TString outputname)
//void flatten_ppMC_X::Loop()
{
//   In a ROOT session, you can do:
//      root> .L flatten_ppMC_X.C
//      root> flatten_ppMC_X t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   */
   ...
   //TFile* outputFile = new TFile("./root_files/X/MC_X.root", "RECREATE");
