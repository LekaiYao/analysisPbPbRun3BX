...
// Wed Nov  5 02:00:22 2025 by ROOT version 6.30/04
// from TTree ntmix/
// found on file: /lstore/cms/hlegoinha/X3872/MC_DATA/DATA_ppRef_X3872.root
//////////////////////////////////////////////////////////

#ifndef flatten_ppDATA_X_h
#define flatten_ppDATA_X_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   flatten_ppDATA_X(TTree *tree=0);
   virtual ~flatten_ppDATA_X();
...
#ifdef flatten_ppDATA_X_cxx
flatten_ppDATA_X::flatten_ppDATA_X(TTree *tree) : fChain(0) 
{
...
flatten_ppDATA_X::~flatten_ppDATA_X()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t flatten_ppDATA_X::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t flatten_ppDATA_X::LoadTree(Long64_t entry)
{
...
void flatten_ppDATA_X::Init(TTree *tree)
{
...
Bool_t flatten_ppDATA_X::Notify()
{
...
void flatten_ppDATA_X::Show(Long64_t entry)
{
...
Int_t flatten_ppDATA_X::Cut(Long64_t entry)
{
...
#endif // #ifdef flatten_ppDATA_X_cxx
