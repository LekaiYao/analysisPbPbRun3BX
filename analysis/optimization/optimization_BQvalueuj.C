...
void optimization_BQvalueuj(int mode = 0) {
    ...
    if (mode == 0) {
        ...
        f_bkg = TFile::Open("../selection/root_files/Bu/sideband_Bu_cut0.root");
        f_sig   = TFile::Open("../selection/root_files/Bu/MC_Bu_cut0.root");
    }
    else if(mode==2){
        f_bkg = TFile::Open("../selection/root_files/Bd/sideband_Bd_cut0.root");
        f_sig   = TFile::Open("../selection/root_files/Bd/MC_Bd_cut0.root");
    }
    else if(mode==3){
        f_bkg = TFile::Open("../selection/root_files/Bs/sideband_Bs_cut0.root");
