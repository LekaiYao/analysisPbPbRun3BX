...
// Fri Sep 26 10:19:33 2025 by ROOT version 6.30/04
// from TTree ntKp/
// found on file: /lstore/cms/hlegoinha/Bmeson/MC_DATA/MC_ppRef_Bmeson/Bu_phat5_Bfinder.root
//////////////////////////////////////////////////////////

#ifndef analysis_Bu_h
#define analysis_Bu_h
...
#ifdef analysis_Bu_cxx
analysis_Bu::analysis_Bu(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/lstore/cms/hlegoinha/Bmeson/MC_DATA/MC_ppRef_Bmeson/Bu_phat5_Bfinder.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/lstore/cms/hlegoinha/Bmeson/MC_DATA/MC_ppRef_Bmeson/Bu_phat5_Bfinder.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/lstore/cms/hlegoinha/Bmeson/MC_DATA/MC_ppRef_Bmeson/Bu_phat5_Bfinder.root:/Bfinder");
...
analysis_Bu::~analysis_Bu()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t analysis_Bu::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analysis_Bu::LoadTree(Long64_t entry)
{
...
void analysis_Bu::Init(TTree *tree)
{
...
void analysis_Bu::Show(Long64_t entry)
{
...
Int_t analysis_Bu::Cut(Long64_t entry)
{
