...
#input_data_path = "../selection/root_files/sideband.root"
#output_root = f"{output_dir}/sideband_X3872_BDT_{run_label}.root"
#input_data_path = "../selection/root_files/MC_X3872.root"
#output_root = f"{output_dir}/MC_X3872_BDT_{run_label}.root"
input_data_path = "../selection/root_files/MC_PSI2S.root"
output_root = f"{output_dir}/MC_PSI2S_BDT_{run_label}.root"
#input_data_path = f"../selection/root_files/DATA_XPSI_cut0.root"
