...
void plot_@VARNAME@() {
    ...
    // Open ROOT files
    TFile *f_data = TFile::Open("../selection/root_files/sideband.root");
    TFile *f_mc   = TFile::Open("../selection/root_files/MC_PSI2S.root");
    TFile *f_mc2  = TFile::Open("../selection/root_files/MC_X3872.root");
